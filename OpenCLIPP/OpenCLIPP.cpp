...
REDUCE_RETURN_OP(ocipSumSqr,        SumSqr,        double)
...
REDUCE_ARG_OP(   ocipSumSqr_4C,     SumSqr,        double)
...
REDUCE_RETURN_OP(ocipSumSqr_V,         SumSqr,        double)
...
REDUCE_ARG_OP(   ocipSumSqr_4C_V,      SumSqr,        double)
