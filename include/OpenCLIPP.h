...
/// as temporary buffer for the processing functions that need them.
...
///      Can either be NULL (for a device-only buffer) or point to an image that fits with the description in Image.
