...
public:
   ...
   void Min(      ImageBuffer& Source, double outVal[4]);   ///< Finds the minimum values in the image
   void Max(      ImageBuffer& Source, double outVal[4]);   ///< Finds the maximum values in the image
