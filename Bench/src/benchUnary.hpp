...
{
#ifndef NO_CUSTOM_CUDA
   CUDA_CODE(
      CUDAPP(BENCH_NAME)<DataType>
         ((DataType*) this->m_CUDASrc, this->m_CUDASrcStep CONSTANT_MIDDLE CONSTANT_LAST, (DataType*) this->m_CUDADst, this->m_CUDADstStep, this->m_ImgSrc.Width, this->m_ImgSrc.Height);
   )
#endif
}
#ifndef NO_UNSIGNED
