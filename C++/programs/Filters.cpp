...
static std::string SelectName(const char * Name, const ImageBase& Img)
{
   ...
   KernelName += "_" + std::to_string(NbChannels) + "C";
...
void Filters::GaussianBlur(IImage& Source, IImage& Dest, float Sigma)
{
   ...
   // Execute kernel
   Kernel(gaussian_blur, In(Source), Out(Dest), MaskBuffer, MaskSize);
}

void Filters::Gauss(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(gaussian3, Source, Dest);
      return;
   }

   if (Width == 5)
   {
      Kernel(gaussian5, Source, Dest);
      return;
   }
...
void Filters::Sharpen(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);
   ...
   Kernel(sharpen3, In(Source), Out(Dest));
}

void Filters::Smooth(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);
   ...
   Kernel(smooth, In(Source), Out(Dest), Width);
}
...
void Filters::Median(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);
   ...
   if (Width == 3)
   {
      ...
      Kernel(median3, Source, Dest);
      return;
   }

   Kernel(median5, Source, Dest);
}

void Filters::SobelVert(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(sobelV3, Source, Dest);
      return;
   }

   if (Width == 5)
   {
      Kernel(sobelV5, Source, Dest);
      return;
   }
...
void Filters::SobelHoriz(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(sobelH3, Source, Dest);
      return;
   }

   if (Width == 5)
   {
      Kernel(sobelH5, Source, Dest);
      return;
   }
...
void Filters::SobelCross(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(sobelCross3, Source, Dest);
      return;
   }

   if (Width == 5)
   {
      Kernel(sobelCross5, Source, Dest);
      return;
   }
...
void Filters::Sobel(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(sobel3, Source, Dest);
      return;
   }

   if (Width == 5)
   {
      Kernel(sobel5, Source, Dest);
      return;
   }
...
void Filters::PrewittVert(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(prewittV3, Source, Dest);
      return;
   }
...
void Filters::PrewittHoriz(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(prewittH3, Source, Dest);
      return;
   }
...
void Filters::Prewitt(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(prewitt3, Source, Dest);
      return;
   }
...
void Filters::ScharrVert(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(scharrV3, Source, Dest);
      return;
   }
...
void Filters::ScharrHoriz(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(scharrH3, Source, Dest);
      return;
   }
...
void Filters::Scharr(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(scharr3, Source, Dest);
      return;
   }
...
void Filters::Hipass(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(hipass3, Source, Dest);
      return;
   }

   if (Width == 5)
   {
      Kernel(hipass5, Source, Dest);
      return;
   }
...
void Filters::Laplace(IImage& Source, IImage& Dest, int Width)
{
   CheckCompatibility(Source, Dest);

   if (Width == 3)
   {
      Kernel(laplace3, Source, Dest);
      return;
   }

   if (Width == 5)
   {
      Kernel(laplace5, Source, Dest);
      return;
   }
